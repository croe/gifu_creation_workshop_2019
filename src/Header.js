    ...
    <div className={classes.root}>
      ...
      <Drawer open={drawer} onClose={handleClose}>
        <List>
          ...
          {/*</ListItem>*/}
          <ListItem button to="/compari" component={Link}>
            <ListItemIcon><DashboardIcon /></ListItemIcon>
            <ListItemText primary="Comparison" />
          </ListItem>
          <ListItem button to="/valueof" component={Link}>
            <ListItemIcon><DashboardIcon /></ListItemIcon>
            <ListItemText primary="ValueOF" />
          </ListItem>
          <ListItem button to="/timetx" component={Link}>
            <ListItemIcon><DashboardIcon /></ListItemIcon>
            <ListItemText primary="TimeTX" />
          </ListItem>
          <ListItem button to="/rulebd" component={Link}>
            <ListItemIcon><DashboardIcon /></ListItemIcon>
            <ListItemText primary="RuleBD" />
          </ListItem>
        </List>
      </Drawer>
    </div>
